          ...
          <div className="top-socials">
            <div className="left">
              <div className="something-on-top">
                ...
                <ul>
                  <li>
                    <Link className="links">Kolkata</Link>
                  </li>
                  <li>
                    <Link className="links">Mumbai</Link>
                  </li>
                  <li>
                    <Link className="links">Chennai</Link>
                  </li>
                  <li>
                    <Link className="links">Pune</Link>
                  </li>
                </ul>
              </div>
              <div className="something-on-top">
                ...
                <ul>
                  <li>
                    <Link className="links">Bhubaneshwar</Link>
                  </li>
                  <li>
                    <Link className="links">Hyderabad</Link>
                  </li>
                  <li>
                    <Link className="links">Chandigarh</Link>
                  </li>
                  <li>
                    <Link className="links">Nashik</Link>
                  </li>
                </ul>
              </div>
              <div
              ...
              >
                ...
                <ul>
                  <li>
                    <Link className="links">Tech@OLX</Link>
                  </li>
                </ul>
              </div>
              <div className="something-on-top">
                ...
                <ul>
                  ...
                  <li>
                    <Link className="links">Legal & Privacy information</Link>
                  </li>
                  <li>
