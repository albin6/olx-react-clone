                            ...
                            user ?
                                <>
                                    <div className='user-avatar'>
                                        <div>
                                            <img style={{ borderRadius: "50%", width: "42px", height: "42px" }} src="https://media.istockphoto.com/id/1300845620/vector/user-icon-flat-isolated-on-white-background-user-symbol-vector-illustration.jpg?s=612x612&w=0&k=20&c=yBeyba0hUkh14_jgv1OKqIH0CCSWU_4ckRkAoy2p73o=" alt="" />
                                            <div className='hover-effecting'>
                                                <Arrow className='logout-arrow' />
                                                <div className='login-btn-container'>
                                                    <button className='login-btn' onClick={handleSignOut}>logout</button>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <Link className='login-btn marging-class' to={'/login'}>Login</Link>
                        }
